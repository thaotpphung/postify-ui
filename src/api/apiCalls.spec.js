...
describe('apiCalls', () => {
  ...
  describe('loadNewPosts', () => {
    ...
    it('calls /api/1.0/users/user3/posts/5?direction=after&sort=id,desc when post id and username param provided', () => {
      const mockGetPosts = jest.fn();
      axios.get = mockGetPosts;
  ...
  describe('loadNewPostCount', () => {
    it('calls /api/1.0/posts/5?direction=after&count=true when post id param provided', () => {
      const mockGetPosts = jest.fn();
      axios.get = mockGetPosts;
    ...
    it('calls /api/1.0/users/user3/posts/5?direction=after&count=true when post id and username param provided', () => {
      const mockGetPosts = jest.fn();
      axios.get = mockGetPosts;
